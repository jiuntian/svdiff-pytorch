...
class DreamBoothDataset(Dataset):
    ...
    def __init__(
        ...
        if Path(instance_data_root).is_dir():
...
if __name__ == "__main__":
    ...
    #     "--instance_data_dir", "/home/jiuntian/data/data/edit_hoi/HICO_train2015_00015971/img.png",
    #     "--output_dir", "./debug-svdiff",
    #     "--instance_prompt", "a person blow cake",
    #     "--train_batch_size", "1",
    #     "--train_text_encoder",
    #     "--lr_warmup_steps", "0",
    #     "--max_train_steps", "500"
    ...
    pretrained_model_name_or_path = "stable-diffusion-v1-5/stable-diffusion-v1-5"
    spectral_shifts_ckpt_dir = "./debug-svdiff"
    image = "/home/jiuntian/data/data/edit_hoi/HICO_train2015_00015971/img.png"
    source_prompt = "a person blow cake"
    target_prompt = "a person cut cake"
    ...
    image.save("./debug-svdiff/result.png")